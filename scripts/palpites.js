...
document.addEventListener("DOMContentLoaded", async () => { 
    ...
    // Referência ao contêiner de categorias
    const categoriasContainer = document.getElementById("categoriasContainer");
    if (!categoriasContainer) {
        console.error("Erro: Elemento 'categoriasContainer' não encontrado no HTML.");
        return;
    }
    ...
    if (!form) {
        console.error("Erro: Elemento 'formPalpites' não encontrado no HTML.");
        return;
    }
